...
//		返回按钮
		JButton exitSystem_1 = new JButton("返回");
		exitSystem_1.addActionListener(listener);//注册事件
		exitSystem_1.setFont(new Font("宋体", Font.PLAIN, 25));
		exitSystem_1.setBounds(263, 265, 155, 50);
		contentPane.add(exitSystem_1);
//		录入试题对话框
